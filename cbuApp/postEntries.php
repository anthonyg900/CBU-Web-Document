...
if(isset($_GET['submit'])){
  $choice_one = $_GET['choice1'];
  $choice_two = $_GET['choice2'];
  $choice_three = $_GET['choice3'];
  $choice_four = $_GET['choice4'];
  $choice_five = $_GET['choice5'];
  $choice_six = $_GET['choice6'];
  $choice_seven = $_GET['choice7'];
  $choice_eight = $_GET['choice8'];
  $choice_nine = $_GET['choice9'];
  $choice_ten = $_GET['choice10'];
  $choice_eleven = $_GET['choice11'];
  $choice_twelve = $_GET['choice12'];
  $name = $_GET['name'];
  $notes = $_GET['notes'];

  $db->query("INSERT INTO posts (choice_one, choice_two, choice_three, choice_four, choice_five,
  ...
  (:choice1, :choice2, :choice3, :choice4, :choice5, :choice6, :choice7, :choice8, :choice9,
    :choice10, :choice11, :choice12, :name, :notes)");
  $db->bind(":choice1", $choice_one);
  $db->bind(":choice2", $choice_two);
  $db->bind(":choice3", $choice_three);
  $db->bind(":choice4", $choice_four);
  $db->bind(":choice5", $choice_five);
  $db->bind(":choice6", $choice_six);
  $db->bind(":choice7", $choice_seven);
  $db->bind(":choice8", $choice_eight);
  $db->bind(":choice9", $choice_nine);
  $db->bind(":choice10", $choice_ten);
  $db->bind(":choice11", $choice_eleven);
  $db->bind(":choice12", $choice_twelve);
  $db->bind(":name", $name);
  $db->bind(":notes", $notes);
  $db->execute();
}
...
<head>
  ...
  <img src="cbu_logo.png" alt="Logo" style="width:200px;height:90px">
